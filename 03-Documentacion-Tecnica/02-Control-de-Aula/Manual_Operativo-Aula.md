...
2. Activar el internet `internet-on` o si falla ese alias tirar `sudo bash /etc/psico/fw_conexion.sh on`
...
1. Prender la PC
2. Mientras este iniciando, apretar repetidamente alguna de las siguientes teclas: F2, F10, F11, F12, DEL o ESC (Generalmente es F2)
3. Salir sin guardar
