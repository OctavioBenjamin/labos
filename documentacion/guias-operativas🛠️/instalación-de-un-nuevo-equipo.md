...
> Se debe ingresar con el usuario administrador y clonar el repositorio ...

`git clone https://github,com/octaviobenjamin/labos`

Una vez que se clone de deben ejecutar distintos scripts

## Intalacion de SSH

Desde el home directory ejecutar:
> sudo bash remoto/install_ssh.sh

Esto lo que hace es instalar ssh 
